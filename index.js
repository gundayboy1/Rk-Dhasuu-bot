...
login({ appState: JSON.parse(fs.readFileSync("appstate.json", "utf8")) }, (err, api) => {
  ...
  api.listenMqtt(async (err, event) => {
    try {
      ...
      const badNames = ["Ritesh", "ritesh", "ritu", "himu", "Ram", "sanju", "Himanshu"];
      ...
      if (
        ...
        return api.sendMessage(
          "teri ma 2 rs ki Rawndi hai tu msg mt kr Rk urf Ritesh Ch0d Deg4 teri ma  ko byy🙂 ss Lekr story Lga by",
          threadID,
          messageID
        );
      }
      ...
      if (cmd === "/allname") {
        ...
        api.sendMessage(`Rk Urf Ritesh Ch0d diya garib ko  🤣rkb ${name}`, threadID);
      }
